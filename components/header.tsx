...
import { ChevronDown, FileText, GraduationCap, ImageIcon, ImagePlayIcon, LayoutDashboard, PenBox, StarsIcon } from 'lucide-react'
          ...
          <SignedIn>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem >
                  <Link href={"/gen-tools"} className="flex items-center gap-2">
